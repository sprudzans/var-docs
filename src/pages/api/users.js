...
import { getAllUsers, createUser, findUserByEmail } from '../../lib/userDB'
...
handler
  ...
  .post((req, res) => {
    ...
    const usernameExisted = !!findUserByEmail(req, email)
    if (usernameExisted) {
    ...
    // const user = { username, password: hashedPass, email }
    createUser(req, user)
